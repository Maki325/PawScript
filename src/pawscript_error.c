...
const char *getPawscriptErrorName(PawscriptError error) {
  ASSERT(ERROR_COUNT == 62, "Not all errors are implemented in getPawscriptErrorName!");
  switch (error) {
    ...
    case ERROR_INVALID_UNICODE_CHAR:                           return "Invalid unicode codepoint!";
    case ERROR_INVALID_BYTE_ESCAPE_SEQUENCE:                   return "Invalid byte escape sequence!";
    case ERROR_INVALID_UNICODE_ESCAPE_SEQUENCE:                return "Invalid unicode escape sequence!";
    ...
    case ERROR_NO_TYPE_AFTER_AMPERSAND:                        return "A type is needed after the reference(`&`) symbol!";
    case ERROR_NO_TYPE_AFTER_AMPERSAND_MUT:                    return "A type is needed after the mutable reference(`&mut`) symbols!";
    case ERROR_UNEXPECTED_TOKEN_AFTER_AMPERSAND_EXPECTED_TYPE: return "Unexpected token after the reference(`&`) symbol! Expected type!";
    case ERROR_NO_NAME_AFTER_AMPERSAND:                        return "A variable name is needed after the reference(`&`) symbol!";
    case ERROR_NO_NAME_AFTER_AMPERSAND_MUT:                    return "A variable name is needed after the mutable reference(`&mut`) symbols!";
    case ERROR_UNEXPECTED_TOKEN_AFTER_AMPERSAND_EXPECTED_NAME: return "Unexpected token after the reference(`&`) symbol! Expected variable names!";
